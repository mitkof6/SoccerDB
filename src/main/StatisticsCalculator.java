...
/**
 * The statistics calculator class
 * 
 * @author Jim Stanev
 */
public class StatisticsCalculator {
	...
	private int matches, nonReal = 0, nonLogic = 0, symmetry1R = 0, 
					symmetry2R = 0, symmetryXR = 0, symmetryTotalR, 
					symmetry1L = 0, symmetry2L = 0, symmetryXL = 0, 
					symmetryTotalL, surprise1 = 0, surprise2 = 0;
	 ...
	 * Constructor
	 */
	public StatisticsCalculator(JTable table, int matches){
	...
	public String getMax(){
		return String.format(Locale.US, "%.2f", maxCoeff);
	}
	...
	public String getMin(){
		return String.format(Locale.US, "%.2f", minCoeff);
	}
	...
	public String getRealCoeff(){
		return String.format(Locale.US, "%.2f", realCoeff);
	}
